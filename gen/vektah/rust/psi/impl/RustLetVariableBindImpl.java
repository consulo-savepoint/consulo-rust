...
public class RustLetVariableBindImpl extends RustLetBindImpl implements RustLetVariableBind {

  public RustLetVariableBindImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RustVisitor) ((RustVisitor)visitor).visitLetVariableBind(this);
