...
public class RustStructBodyBlockImpl extends RustStructBodyImpl implements RustStructBodyBlock {

  public RustStructBodyBlockImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RustVisitor) ((RustVisitor)visitor).visitStructBodyBlock(this);
