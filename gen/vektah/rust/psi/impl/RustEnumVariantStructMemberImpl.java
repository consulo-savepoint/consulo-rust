...
public class RustEnumVariantStructMemberImpl extends RustEnumVariantImpl implements RustEnumVariantStructMember {

  public RustEnumVariantStructMemberImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RustVisitor) ((RustVisitor)visitor).visitEnumVariantStructMember(this);
