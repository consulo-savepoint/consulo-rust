...
public class RustExprAsImpl extends RustExprImpl implements RustExprAs {

  public RustExprAsImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RustVisitor) ((RustVisitor)visitor).visitExprAs(this);
