...
public class RustTypeVectorImpl extends ASTWrapperPsiElement implements RustTypeVector {

  public RustTypeVectorImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RustVisitor) ((RustVisitor)visitor).visitTypeVector(this);
