...
public class RustPrototypeStructArgImpl extends ASTWrapperPsiElement implements RustPrototypeStructArg {

  public RustPrototypeStructArgImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RustVisitor) ((RustVisitor)visitor).visitPrototypeStructArg(this);
