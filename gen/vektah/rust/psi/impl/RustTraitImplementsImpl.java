...
public class RustTraitImplementsImpl extends ASTWrapperPsiElement implements RustTraitImplements {

  public RustTraitImplementsImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RustVisitor) ((RustVisitor)visitor).visitTraitImplements(this);
