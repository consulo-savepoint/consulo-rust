...
public class RustEnumVariantTupleImpl extends RustEnumVariantImpl implements RustEnumVariantTuple {

  public RustEnumVariantTupleImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RustVisitor) ((RustVisitor)visitor).visitEnumVariantTuple(this);
