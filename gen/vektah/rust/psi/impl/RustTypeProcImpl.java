...
public class RustTypeProcImpl extends ASTWrapperPsiElement implements RustTypeProc {

  public RustTypeProcImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RustVisitor) ((RustVisitor)visitor).visitTypeProc(this);
    else super.accept(visitor);
  }

  @Override
  @NotNull
  public RustFnPrototypeArgs getFnPrototypeArgs() {
    return findNotNullChildByClass(RustFnPrototypeArgs.class);
  }
  ...
  @Override
  @NotNull
  public List<RustTraitBounds> getTraitBoundsList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, RustTraitBounds.class);
  }
