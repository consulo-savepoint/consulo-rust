...
public class RustFnDeclarationImpl extends ASTWrapperPsiElement implements RustFnDeclaration {

  public RustFnDeclarationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RustVisitor) ((RustVisitor)visitor).visitFnDeclaration(this);
  ...
  public RustFnArgs getFnArgs() {
    return findChildByClass(RustFnArgs.class);
  }
