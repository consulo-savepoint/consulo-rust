...
public class RustImplForImpl extends ASTWrapperPsiElement implements RustImplFor {

  public RustImplForImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RustVisitor) ((RustVisitor)visitor).visitImplFor(this);
