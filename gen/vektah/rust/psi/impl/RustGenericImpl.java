...
public class RustGenericImpl extends ASTWrapperPsiElement implements RustGeneric {

  public RustGenericImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RustVisitor) ((RustVisitor)visitor).visitGeneric(this);
